...
export const PinBar = styled.div<{
    ...
    ${(props) =>
        ...
        css`
            top: 0;
            animation: topBounce 1s cubic-bezier(0.2, 0.9, 0.5, 1.16) forwards;
        `}
                ...
                <PinBar accent position="top">
                    <div style={{ height: "auto" }}>
                        ...
                        <div
                            ...
                            {renderer.pinned_messages
                                .slice()
                                .reverse()
                                .map((msg, i) => {
                                    if (msg.is_pinned) {
                                        let content = msg.content
                                            ? truncateText(msg.content, 220)
                                            : "";
                                        pinFound = true;
                                        return (
                                            <div
