...
/**
 * The favicon smiley (assets/logo_round.svg) inlined so each pixel block can
 * animate on its own — the mark assembles block-by-block on page load.
 * Keep the paths in sync with the SVG asset.
 */
