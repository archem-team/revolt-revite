...
export function SubmitModal({
    ...
    const [showCustomWarehouseInput, setShowCustomWarehouseInput] =
        useState(false);
    const [availableCustomWarehouses, setAvailableCustomWarehouses] = useState<
        string[]
    >([]);
    ...
    function addCustomWarehouse() {
        ...
        setAvailableCustomWarehouses((prev) =>
        ...
        if (!current.includes(val)) {
            setForm((f) => ({
                ...f,
                warehouses: { ...f.warehouses, custom: [...current, val] },
            }));
        }
    ...
    function handleSubmit(e: Event) {
        ...
        if (!form.inviteLink.trim()) {
            setError("PepChat invite link is required.");
            return;
        }
        ...
        if (isCommerce) {
            ...
            if (words > 10) {
                setError(
                    `Server description must be 10 words or less (currently ${words}).`,
                );
                return;
            }
        }
                    ...
                    {submitted ? (
                        <div style={{ textAlign: "center", padding: "36px 0" }}>
                            ...
                            <div
                                ...
                                Your community will be reviewed and added
                                shortly.
                            </div>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit}>
                            ...
                            <FormGroup>
                                <label>
                                    PepChat Server ID (optional — enables live
                                    member stats)
                                </label>
                                <input
                                    type="text"
                                ...
                                <>
                                    ...
                                    <FormGroup>
                                        <div
                                            ...
                                            <div
                                                ...
                                                onMouseEnter={() =>
                                                    setShowProofInfo(true)
                                                }
                                                onMouseLeave={() =>
                                                    setShowProofInfo(false)
                                                }>
                                                <button
                                                    type="button"
                                                    style={{
                                    ...
                                    <FormGroup>
                                        ...
                                        <div
                                            ...
                                            Made-in-China, Alibaba, or other
                                            public profiles
                                        </div>
                                    </FormGroup>
