    ...
    return (
        <Page $dark={darkMode}>
            ...
            <Header>
                ...
                <HeaderSpacer />
                <NavSubmitGroup>
                    <NavSubmitBtn onClick={() => openSubmit("vendor")}>
                        + Vendor
                    </NavSubmitBtn>
                    <NavSubmitBtn onClick={() => openSubmit("reseller")}>
                        + Reseller
                    </NavSubmitBtn>
                </NavSubmitGroup>
                <NavDivider />
                    ...
                    {loggedIn ? (
                        ...
                        <>
                            <DesktopAuthGroup>
                                ...
                                <NavBtn href="/login/create" $primary>
                                    Register
                                </NavBtn>
                            </DesktopAuthGroup>
            ...
            <Hero>
                <HeroInner>
                    ...
                    <HeroSub>
                        Community-curated directory of trusted peptide
                        communities. Compare vendors, resellers, and general
            ...
            <Main>
                ...
                {loading ? (
                    ...
                    <EmptyState>
                        ...
                        Failed to load directory data. Please refresh and try
                        again.
                    </EmptyState>
                ) : filtered.length === 0 ? (
                    <EmptyState>
            ...
            <Footer>
                <div>
                    ...
                    <p className="disclaimer">
                        Information is community-maintained and may not be
                        current. Not affiliated with or endorsing any listed
                        community.
                    </p>
                </div>
                <FooterLinks>
            ...
            {reviewModal && (
                <ReviewsModal
                    ...
                    reviews={reviews.filter(
                        (r) =>
                            r.vendorId === reviewModal.id &&
                            r.vendorType === reviewModal.type,
                    )}
